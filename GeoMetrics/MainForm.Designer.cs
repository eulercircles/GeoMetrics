namespace GeoMetrics
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.tabPage_3DAngle = new System.Windows.Forms.TabPage();
			this.tabPage_Scaling = new System.Windows.Forms.TabPage();
			this.tabControl1.SuspendLayout();
			this.tabPage_3DAngle.SuspendLayout();
			this.SuspendLayout();
			// 
			...
			this.fractionalInchTextBox_AX.Denominator = FlintLib.Geometrics.ImperialDenominators.ThirtySecond;
			...
			this.fractionalInchTextBox_AY.Denominator = FlintLib.Geometrics.ImperialDenominators.ThirtySecond;
			...
			this.fractionalInchTextBox_AZ.Denominator = FlintLib.Geometrics.ImperialDenominators.ThirtySecond;
			...
			this.fractionalInchTextBox_BZ.Denominator = FlintLib.Geometrics.ImperialDenominators.ThirtySecond;
			...
			this.fractionalInchTextBox_BY.Denominator = FlintLib.Geometrics.ImperialDenominators.ThirtySecond;
			...
			this.fractionalInchTextBox_BX.Denominator = FlintLib.Geometrics.ImperialDenominators.ThirtySecond;
			...
			// tabControl1
			// 
			this.tabControl1.Controls.Add(this.tabPage_3DAngle);
			this.tabControl1.Controls.Add(this.tabPage_Scaling);
			this.tabControl1.Dock = System.Windows.Forms.DockStyle.Fill;
			this.tabControl1.Location = new System.Drawing.Point(0, 0);
			this.tabControl1.Name = "tabControl1";
			this.tabControl1.SelectedIndex = 0;
			this.tabControl1.Size = new System.Drawing.Size(629, 262);
			this.tabControl1.TabIndex = 16;
			// 
			// tabPage_3DAngle
			// 
			this.tabPage_3DAngle.Controls.Add(this.label3);
			this.tabPage_3DAngle.Controls.Add(this.label7);
			this.tabPage_3DAngle.Controls.Add(this.fractionalInchTextBox_AX);
			this.tabPage_3DAngle.Controls.Add(this.textBox_Angle);
			this.tabPage_3DAngle.Controls.Add(this.label6);
			this.tabPage_3DAngle.Controls.Add(this.fractionalInchTextBox_AY);
			this.tabPage_3DAngle.Controls.Add(this.label5);
			this.tabPage_3DAngle.Controls.Add(this.fractionalInchTextBox_AZ);
			this.tabPage_3DAngle.Controls.Add(this.label4);
			this.tabPage_3DAngle.Controls.Add(this.textBox_ALength);
			this.tabPage_3DAngle.Controls.Add(this.fractionalInchTextBox_BX);
			this.tabPage_3DAngle.Controls.Add(this.label2);
			this.tabPage_3DAngle.Controls.Add(this.fractionalInchTextBox_BY);
			this.tabPage_3DAngle.Controls.Add(this.label1);
			this.tabPage_3DAngle.Controls.Add(this.fractionalInchTextBox_BZ);
			this.tabPage_3DAngle.Controls.Add(this.textBox_BLength);
			this.tabPage_3DAngle.Location = new System.Drawing.Point(4, 22);
			this.tabPage_3DAngle.Name = "tabPage_3DAngle";
			this.tabPage_3DAngle.Padding = new System.Windows.Forms.Padding(3);
			this.tabPage_3DAngle.Size = new System.Drawing.Size(621, 236);
			this.tabPage_3DAngle.TabIndex = 0;
			this.tabPage_3DAngle.Text = "3D Angles";
			this.tabPage_3DAngle.UseVisualStyleBackColor = true;
			// 
			// tabPage_Scaling
			// 
			...
			this.tabPage_3DAngle.ResumeLayout(false);
			this.tabPage_3DAngle.PerformLayout();
		...
		private System.Windows.Forms.TabPage tabPage_3DAngle;
